...
class calendarnuse extends StatefulWidget {
  // static String calendarid = 'calender';
  const calendarnuse({Key? key}) : super(key: key);

  @override
  _calendarnuseState createState() => _calendarnuseState();
}

class _calendarnuseState extends State<calendarnuse> {
  ...
  @override
  void initState() {
    // BlocProvider.of<CalenderdoctorCubit>(context)
    //     .showevents(eventdate: _focusedCalendarDate);
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
                ...
                onDaySelected: (selectedDay, focusedDay) {
                  ...
                  if (!isSameDay(selectedCalendarDate, selectedDay)) {
                    setState(() {
                      ...
                      BlocProvider.of<CalendernurseCubit>(context)
                          .showevents(eventdate: selectedCalendarDate!);
                    });
                  }
                },
            ...
            BlocBuilder<CalendernurseCubit, CalendernurseState>(
                builder: (context, state) {
              if (state is Calendernursesubitted) {
                return ListTile(
                  leading: const Icon(
                    Icons.done,
                    color: kprimarycolor,
                ...
                TextButton(
                  onPressed: () {
                    if (titleController.text.isEmpty &&
                      ...
                      setState(() {
                        BlocProvider.of<CalendernurseCubit>(context).addevent(
