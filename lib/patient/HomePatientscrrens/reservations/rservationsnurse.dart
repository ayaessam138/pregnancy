...
class reservationsnurse extends StatelessWidget {
  const reservationsnurse({Key? key}) : super(key: key);
static String reservationsnurseid = 'reservationsnurse';
...
// class reservationsnurse extends StatefulWidget {
//   const reservationsnurse({Key? key}) : super(key: key);
//
//
//   @override
//   State<reservationsnurse> createState() => _reservationsnurseState();
// }
//
// //object?.something
// class _reservationsnurseState extends State<reservationsnurse> {
//   bool isLoading = true;
//   List users = [];
//   List doctor = [];
//   List time = [];
